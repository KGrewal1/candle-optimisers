...
/* The results of this test have been checked against the following PyTorch code.
    ...
    with torch.no_grad():
        m.weight.zero_()
        m.bias.zero_()
    optimizer = optim.RMSprop(m.parameters(), weight_decay = 0.4)
    # optimizer.zero_grad()
    for _step in range(100):
        optimizer.zero_grad()
        ys = m(sample_xs)
...
/* The results of this test have been checked against the following PyTorch code.
    ...
    with torch.no_grad():
        m.weight.zero_()
        m.bias.zero_()
    optimizer = optim.RMSprop(m.parameters(), centered = True)
    # optimizer.zero_grad()
    for _step in range(100):
        optimizer.zero_grad()
        ys = m(sample_xs)
...
/* The results of this test have been checked against the following PyTorch code.
    ...
    with torch.no_grad():
        m.weight.zero_()
        m.bias.zero_()
    optimizer = optim.RMSprop(m.parameters(), momentum = 0.4)
    # optimizer.zero_grad()
    for _step in range(100):
        optimizer.zero_grad()
        ys = m(sample_xs)
...
/* The results of this test have been checked against the following PyTorch code.
    ...
    with torch.no_grad():
        m.weight.zero_()
        m.bias.zero_()
    optimizer = optim.RMSprop(m.parameters(), momentum = 0.4, weight_decay = 0.4)
    # optimizer.zero_grad()
    for _step in range(100):
        optimizer.zero_grad()
        ys = m(sample_xs)
...
/* The results of this test have been checked against the following PyTorch code.
    ...
    with torch.no_grad():
        m.weight.zero_()
        m.bias.zero_()
    optimizer = optim.RMSprop(m.parameters(), centered = True, momentum = 0.4)
    # optimizer.zero_grad()
    for _step in range(100):
        optimizer.zero_grad()
        ys = m(sample_xs)
...
/* The results of this test have been checked against the following PyTorch code.
    ...
    with torch.no_grad():
        m.weight.zero_()
        m.bias.zero_()
    optimizer = optim.RMSprop(m.parameters(), centered = True, momentum = 0.4, weight_decay = 0.4)
    # optimizer.zero_grad()
    for _step in range(100):
        optimizer.zero_grad()
        ys = m(sample_xs)
